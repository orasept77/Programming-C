...
int main(int argc, char const *argv[])
{
    ...
    // int array[3] = {1,2,3}; zapis równoważy z powyższą deklaracją oraz późniejszym przypisaniem wartości.
    // int array[] = {1,2,3}; zapis równoważy z powyższą deklaracją oraz późniejszym przypisaniem wartości.
