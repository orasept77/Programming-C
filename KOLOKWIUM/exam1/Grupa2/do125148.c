...
void miejscaZerowe(struct funkcjakwadratowa *tf) // wskaznik *tf to wskaznik do skturktury true/false (*tf).delta etc, 
...
int main(int argc, char const *argv[])
{
    ...
    *wsk1 = 125148;
    ...
    for (int i = 0; i <= 100; ++i)
    {
        task11_var[i].a = (rand() % 10); // Random pozwa na wybieranie losowych cyfr roznych od 10
